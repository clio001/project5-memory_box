    ...
    >
      <Box
        sx={{
          ...
          background: `#f6f6f6 url(${
            user && user?.groups[0].banner_url
              ? user?.groups[0].banner_url
              : "./profile-bg.jpg"
      ...
      >
        ...
        >
          <img
            src={
              user && user?.groups[0].avatar_url
                ? user?.groups[0].avatar_url
                : "./profile.svg"
            }
            alt="profile img"
            style={{
      ...
      >
        <Box sx={{ display: "flex", alignItems: "center" }}>
          <Avatar
            ...
            sx={{ width: "33px", height: "33px", mr: "5px" }}
          />
          <Avatar
            alt="Travis Howard"
      ...
      >
        <Box sx={{ display: "flex" }}>
          <Avatar
            alt="Remy Sharp"
            src={user && user?.avatar_url ? user?.avatar_url : "./profile.svg"}
      ...
      >
        {user &&
          user?.groups[0].items.map((element2: any, i: string) => {
            return (
              <Box
